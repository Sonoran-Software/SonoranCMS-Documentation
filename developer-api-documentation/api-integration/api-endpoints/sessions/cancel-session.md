---
description: >-
  This endpoint allows you to cancel the current session for the specified
  server ID.
---
...
<mark style="color:green;">`POST`</mark> `https://api.sonorancms.com/sessions/cancel`
...
| type<mark style="color:red;">\*</mark> | string | CANCEL\_SESSION          |
...
```json
{
    ...
    "data": [
        {
            "serverId": 1,
            "accId": "ACCID_OF_USER_CANCELLING_SESSION",
        }
    ]
}
```
