---
description: >-
  This endpoint allows you to get the current session for the specified server
  ID.
---
...
<mark style="color:green;">`POST`</mark> `https://api.sonorancms.com/sessions/get_current`
...
| type<mark style="color:red;">\*</mark> | string | GET\_CURRENT\_SESSION    |
