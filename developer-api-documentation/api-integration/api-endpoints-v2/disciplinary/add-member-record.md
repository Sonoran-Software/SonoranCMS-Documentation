...
<mark style="color:green;">`POST`</mark> `https://api.sonorancms.com/v2/community/disciplinary/accounts/:accountId/records`
{% swagger method="post" path="/v2/community/disciplinary/accounts/:accountId/records" baseUrl="https://api.sonorancms.com" summary="Add Member Record" %}
{% swagger-description %}
Creates a new disciplinary record.
...
- Returns the created record inside the v2 envelope.
