---
description: Recommended safe rate limits for the v2 API.
---

# V2 Rate Limits

{% hint style="info" %}
These are the recommended ceilings to plan against. The Kong gateway is configured slightly higher than the values below to leave a small burst buffer for normal gameplay behavior.
