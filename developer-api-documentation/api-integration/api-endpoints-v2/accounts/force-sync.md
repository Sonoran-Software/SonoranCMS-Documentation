---
description: Forces a community account sync.
---
...
<mark style="color:green;">`POST`</mark> `https://api.sonorancms.com/v2/community/accounts/:accountId/sync`
{% swagger method="post" path="/v2/community/accounts/:accountId/sync" baseUrl="https://api.sonorancms.com" summary="Force Sync" %}
{% swagger-description %}
Forces a community account sync.
...
<pre class="language-json"><code class="lang-json">{
    &quot;meta&quot;:  {
                 ...
                 &quot;path&quot;:  &quot;/v2/community/accounts/:accountId/sync&quot;
             },
    &quot;data&quot;:  {
...
<pre class="language-json"><code class="lang-json">{
    ...
    &quot;instance&quot;:  &quot;/v2/community/accounts/:accountId/sync&quot;,
...
- Body accepts identity fields used to locate the account.
...
- Returns the sync result inside the v2 envelope.
