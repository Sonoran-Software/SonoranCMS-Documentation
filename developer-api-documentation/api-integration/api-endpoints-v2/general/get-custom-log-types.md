---
description: Returns the configured custom log types.
---
...
{% swagger method="get" path="/v2/community/custom-log-types" baseUrl="https://api.sonorancms.com" summary="Get Custom Log Types" %}
{% swagger-description %}
Returns the configured custom log types.
...
<pre class="language-json"><code class="lang-json">{
    ...
    &quot;instance&quot;:  &quot;/v2/community/custom-log-types&quot;,
...
- Returns the custom log type definitions that can be reused by integrations.
