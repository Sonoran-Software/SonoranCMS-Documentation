---
description: Returns community departments and rank metadata.
---
...
{% swagger method="get" path="/v2/community/departments" baseUrl="https://api.sonorancms.com" summary="Get Departments" %}
{% swagger-description %}
Returns community departments and rank metadata.
...
<pre class="language-json"><code class="lang-json">{
    ...
    &quot;instance&quot;:  &quot;/v2/community/departments&quot;,
...
- Returns the department list with nested ranks and ordering metadata.
