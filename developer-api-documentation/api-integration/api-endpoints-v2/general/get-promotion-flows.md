---
description: Returns the available promotion flows for the community.
---
...
{% swagger method="get" path="/v2/community/promotion-flows" baseUrl="https://api.sonorancms.com" summary="Get Promotion Flows" %}
{% swagger-description %}
Returns the available promotion flows for the community.
...
<pre class="language-json"><code class="lang-json">{
    ...
    &quot;instance&quot;:  &quot;/v2/community/promotion-flows&quot;,
...
- Returns the current promotion flow definitions.
